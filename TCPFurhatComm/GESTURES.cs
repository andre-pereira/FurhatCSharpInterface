...
namespace TCPFurhatComm
{
    public enum BASICPARAMS
    {
        ...
        EYE_SQUINT_RIGHT, LOOK_DOWN, LOOK_LEFT, LOOK_RIGHT, LOOK_UP, LOOK_DOWN_LEFT, LOOK_DOWN_RIGHT, 
        LOOK_LEFT_LEFT, LOOK_LEFT_RIGHT, LOOK_RIGHT_LEFT, LOOK_RIGHT_RIGHT, LOOK_UP_LEFT, LOOK_UP_RIGHT,
        GAZE_PAN, GAZE_TILT, EARS_OUT,
    ...
    public enum CHARPARAMS
    {
        ...
        MOUTH_DOWN, MOUTH_FLATTER, MOUTH_NARROWER, MOUTH_SCALE, MOUTH_UP, MOUTH_WIDER, LIP_BOTTOM_THICKER,
        LIP_BOTTOM_THINNER, LIP_TOP_THICKER, LIP_TOP_THINNER,
        
        CHEEK_BONES_DOWN, CHEEK_BONES_NARROWER, CHEEK_BONES_UP, CHEEK_BONES_WIDER, CHEEK_FULLER,
        CHEEK_THINNER, CHIN_DOWN, CHIN_NARROWER, CHIN_UP, CHIN_WIDER, NOSE_DOWN, NOSE_NARROWER,
        NOSE_UP,NOSE_WIDER
    }
